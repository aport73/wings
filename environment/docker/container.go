...
func (e *Environment) Create() error {
        ...
        if strings.HasPrefix(e.meta.Image, "ghcr.io/david1117dev/lumenvm") && e.meta.Image != "ghcr.io/david1117dev/lumenvm:shell" {
                e.log().Debug("environment/docker: LumenVM")
                ...
                evs = append(evs, "ADDITIONAL_PORTS_AUTO="+strings.Join(ports, ","))
                evs = append(evs, "DISK_SPACE_AUTO="+strconv.FormatInt(e.Configuration.Limits().DiskSpace, 10))
        }
